...
export class AudioManager
{
  ...
  /**
   * @method playTurboActivate
   * @description Rising sawtooth sweep for turbo-shot activation.
   */
  ...
  /**
   * @method playSlowFieldActivate
   * @description Low sine tone for slow-field activation.
   */
  ...
  /**
   * @method playCurveActivate
   * @description Quick two-note square-wave chirp for curve-shot activation.
   */
  ...
  /**
   * @method playShieldSpawn
   * @description Bright triangle ping when a shield power-up spawns.
   */
  ...
  /**
   * @method playShieldBreak
   * @description Noise burst + descending tone when a shield is shattered.
   */
  ...
  /**
   * @method playUpgradePurchase
   * @description Two-note ascending chime for upgrade purchase confirmation.
   */
  ...
  /**
   * @method playCooldownReady
   * @description Short ping when an ability cooldown finishes.
   */
